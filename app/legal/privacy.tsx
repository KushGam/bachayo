...
export default function PrivacyScreen() {
  return (
    <LegalScreen title="Privacy Policy" lastUpdated="June 2026">
      ...
      <LegalParagraph>
        This Privacy Policy explains what information LastBag collects, how we use it, and your
        rights. We keep this simple and honest.
      </LegalParagraph>

      <LegalSection title="1. What we collect">
        {`When you use LastBag, we collect:
...
• Improve the LastBag app and fix issues
...
We use the following services to operate LastBag:
• Supabase (database and authentication) — data stored in Singapore region
• Expo (push notifications)
• Vercel (backend infrastructure)

These providers process data only as needed to run LastBag and are bound by their own privacy policies.`}
      </LegalSection>
...
You can disable notifications at any time in your phone Settings or inside the LastBag app under Profile → Notifications.`}
      </LegalSection>
...
privacy@lastbag.app`}
      ...
      <LegalSection title="7. Children">
        LastBag is not intended for children under 13. We do not knowingly collect data from
        children.
      </LegalSection>

      <LegalSection title="8. Changes to this policy">
        We may update this Privacy Policy. We will notify you of significant changes via the app.
        Continued use of LastBag after changes means you accept the updated policy.
      </LegalSection>
