  ...
  return (
    <ScrollView
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>Your account has been temporarily suspended.</Text>
        {reason ? (
      ...
      <Pressable style={styles.contactButton} onPress={() => void Linking.openURL('tel:0405290710')}>
        <Text style={styles.contactButtonText}>Call 0405 290 710</Text>
      </Pressable>
